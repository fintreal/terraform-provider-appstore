...
type BundleIdRelationships struct {
	...
	App *BundleIdRelationshipsApp `json:"app,omitempty"`
}
...
func (o *BundleIdRelationships) GetApp() BundleIdRelationshipsApp {
	if o == nil || IsNil(o.App) {
		var ret BundleIdRelationshipsApp
		return ret
	}
	return *o.App
}
...
// SetApp gets a reference to the given BundleIdRelationshipsApp and assigns it to the App field.
